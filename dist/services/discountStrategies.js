...
exports.SeasonalPromoDiscountStrategy = exports.LoyaltyDiscountStrategy = void 0;
const featureFlagDecorator_1 = require("./featureFlagDecorator"); // Import the decorator
let LoyaltyDiscountStrategy = (() => {
    let _classDecorators = [(0, featureFlagDecorator_1.FeatureFlag)('loyalty')];
...
let SeasonalPromoDiscountStrategy = (() => {
    let _classDecorators = [(0, featureFlagDecorator_1.FeatureFlag)('seasonalPromo')];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var SeasonalPromoDiscountStrategy = _classThis = class {
        applyDiscount(order) {
            return 5; // Example: applies a $5 discount
        }
    };
